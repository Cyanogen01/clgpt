...
def main():
    ...
    tf_3_Temp = -10
    tf_4_Temp = -20
    train_dir = r'C:\Users\iCosMea Pro\SOC estimation\csv_data\\'+str(source_Temp)+r'deg\train_10sparse_mixpro'
    test_dir = r'C:\Users\iCosMea Pro\SOC estimation\csv_data\\'+str(source_Temp)+r'deg\test_10sparse_mixpro'
    tf_train_dir_1 = r'C:\Users\iCosMea Pro\SOC estimation\csv_data\\'+str(tf_1_Temp)+r'deg\train_10sparse_mixpro'
    tf_test_dir_1 = r'C:\Users\iCosMea Pro\SOC estimation\csv_data\\'+str(tf_1_Temp)+r'deg\test_10sparse_mixpro'
    tf_train_dir_2 = r'C:\Users\iCosMea Pro\SOC estimation\csv_data\\'+str(tf_2_Temp)+r'deg\train_10sparse_mixpro'
    tf_test_dir_2 = r'C:\Users\iCosMea Pro\SOC estimation\csv_data\\'+str(tf_2_Temp)+r'deg\test_10sparse_mixpro'
    tf_train_dir_3 = r'C:\Users\iCosMea Pro\SOC estimation\csv_data\\' + str(tf_3_Temp) + r'deg\train_10sparse_mixpro'
    tf_test_dir_3 = r'C:\Users\iCosMea Pro\SOC estimation\csv_data\\' + str(tf_3_Temp) + r'deg\test_10sparse_mixpro'
    tf_train_dir_4 = r'C:\Users\iCosMea Pro\SOC estimation\csv_data\\' + str(tf_4_Temp) + r'deg\train_10sparse_mixpro'
    tf_test_dir_4 = r'C:\Users\iCosMea Pro\SOC estimation\csv_data\\' + str(tf_4_Temp) + r'deg\test_10sparse_mixpro'
    ...
    with open(r'C:\Users\iCosMea Pro\SOC estimation\csv_data\\'+ str(source_Temp) +r'deg\test_10sparse\LA92_10sparse.csv', 'r') as f:
        reader = csv.reader(f)
        head = next(reader)
    ...
    gp_input_shape = (1,)
    batch_size = 128
    epochs = 1000  # epoch:1000 lr:-3 len:64 dim:64 -> 0.008/0.25
    ...
    train(CNN_GRU_model_tf2, data_tf_1, callbacks=None,
          epochs=LSMT_epochs_tf, batch_size=batch_size, verbose=1)
    CNN_GRU_time_tf2_end = time.time()
    CNN_GRU_time_tf2 = CNN_GRU_time_tf2_end - CNN_GRU_time_tf2_start
    y_pred_CNN_GRU_tf2 = CNN_GRU_model_tf2.predict(data_tf_1['test'][0])
    ...
    plt.plot(range(len(y_test)), y_pre[0].flatten(), color='r', lw=1, ls='--', marker='o', markevery=3, markersize=5,
    ...
    plt.plot(range(len(y_test)), y_pred_CNN_LSTM.flatten(), color='c', lw=0, ls='--', marker='v', markevery=3, markersize=5,
              label='CNN-LSTM', alpha=0.9)

    plt.plot(range(len(y_test)), y_pred_CNN_GRU.flatten(), color='tab:brown', lw=1, ls='--', marker='X', markevery=3, markersize=5,
    ...
    plt.plot(range(len(y_test)), y_pred_CNN_LSTM.flatten()  - y_test, color='c', lw=0, ls='--', marker='1', markevery=3, markersize=5,
              label='CNN-LSTM', alpha=0.9)
